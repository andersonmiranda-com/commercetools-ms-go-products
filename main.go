...
import (
	...
	"github.com/andersonmiranda-com/commercetools-go-sdk/ctutils"
...
func main() {
	...
	client, err := platform.NewClient(&platform.ClientConfig{
		...
		Credentials: &clientcredentials.Config{
			TokenURL:     os.Getenv("CT_AUTH_URL"),
			ClientID:     os.Getenv("CT_CLIENT_ID"),
			ClientSecret: os.Getenv("CT_CLIENT_SECRET"),
			Scopes:       []string{os.Getenv("CT_SCOPE")},
		},
	})
	...
	projectClient := client.WithProjectKey(os.Getenv("CT_PROJECT_KEY"))
